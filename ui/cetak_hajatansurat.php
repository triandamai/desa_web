...
<title>Print Data IJIN KHAJATAN</title>
<body onLoad="window.print()">
<?php


foreach($db->tampil_pengantar_hajatan($_GET['id']) as $d) {
    if($d != null){
?>
...
<table width=100%>
<tr>
    <td align="center"><h3 style='margin-bottom:-5px' align=center><u>SURAT IJIN KHAJATAN</u> </h3></td>
</tr> 
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_hajatan]"; ?>-DS-IX-2019</p></td>
</tr> 
</table>
...
<td></td>
<td>Keterangan</td>
<td style="word-wrap: break-word;">: <?php echo "$d[keterangan]";?></td>
</tr>
<tr>
<td></td>
<td>Masa Berlaku</td>
