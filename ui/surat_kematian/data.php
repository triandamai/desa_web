...
?>
<div class="card-body">
                                <h4 class="card-title">Data Surat Kematian</h4>
                                    ...
                                    <table id="multi_col_order"
                                        ...
                                        foreach($db->tampil_kematian(null) as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?= $base_url.'/ui/cetak_kematiansurat.php?module=cetak&&ref=yes&&id='.$data['id_kematian']; ?>"lass="btn waves-effect waves-light btn-outline-primary">
                                                    Cetak
                                                    </a>
                                                    <form action="" method="POST">
                                                        <input type="hidden" name="id" value="<?=  $data['id_kematian'];?>">
