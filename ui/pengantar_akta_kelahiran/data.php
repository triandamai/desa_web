...
?>
<div class="card-body">
                                <h4 class="card-title">Data Akta Kelahiran</h4>
                                    ...
                                    <table id="multi_col_order"
                                        ...
                                        foreach($db->tampil_akta(null) as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?= $base_url.'/ui/cetak_aktasurat.php?module=cetak_pengantar_skck&&ref=yes&&id='.$data['id_akta']; ?>"lass="btn waves-effect waves-light btn-outline-primary">
                                                    Cetak
                                                    </a>
                                                    <form action="" method="POST">
                                                        <input type="hidden" name="id" value="<?=  $data['id_akta'];?>">
