<?php 
        ...
        if(isset($_POST['hapus'])){
            $id = $_POST['id'];
            $simpan = $db->hapus_sktm_sekolah($id);
            if($simpan){
...
?>
<div class="card-body">
                                <h4 class="card-title">Data Surat Tidak Mampu Untuk Sekolah</h4>
                                    ...
                                    <table id="multi_col_order"
                                        ...
                                        foreach($db->tampil_sktm_sekolah(null) as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?= $base_url.'/ui/cetak_sktm_sekolahsurat.php?module=cetak_pengantar_skck&&ref=yes&&id='.$data['id_sktm_sekolah']; ?>"lass="btn waves-effect waves-light btn-outline-primary">
                                                    Cetak
                                                    </a>
                                                    <form action="" method="POST">
                                                        <input type="hidden" name="id" value="<?=  $data['id_sktm_sekolah'];?>">
