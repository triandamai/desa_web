...
<title>Print Data DOMSILI</title>
<body onLoad="window.print()">
<?php


foreach($db->tampil_domisili($_GET['id']) as $d) {
    if($d != null){
?>
...
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_domisili]"; ?>-DS-IX-2019</p></td>
</tr> 
</table>
...
<p>Berdasaarkan Surat Pengantar dari ketua Rukun Tetangga bahwa yang bersangkutan warga desa lumbir sampai dengan sekarang</p>
