...
<title>Print Data Akta kelahiran</title>
<body onLoad="window.print()">
<?php


foreach($db->tampil_akta($_GET['id']) as $d) {
    if($d != null){
?>
...
<table width=100%>
<tr>
    <td align="center"><h3 style='margin-bottom:-5px' align=center><u>SURAT KETERANGAN PENGANTAR AKTA KELAHIRAN</u> </h3></td>
</tr> 
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_akta]"; ?>-DS-IX-2019</p></td>
</tr> 
</table>
