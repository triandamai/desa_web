                                    ...
                                    <table id="multi_col_order"
                                        ...
                                        foreach($db->tampil_sktm(null) as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?= $base_url.'/ui/cetak_sktmsurat.php?module=cetak_pengantar_skck&&ref=yes&&id='.$data['id_sktm'] ?>"lass="btn waves-effect waves-light btn-outline-primary">
                                                    Cetak
                                                    </a>
                                                    <form action="" method="POST">
                                                        <input type="hidden" name="id" value="<?=  $data['id_sktm'];?>">
