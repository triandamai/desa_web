...
foreach($db->tampil_sktm($_GET['id']) as $d) {
    if($data != null){
?>
...
<tr>
    <td align="center"><p>Jl. Raya Lumbir  Nomor 38 
Tlp.(081) 6575624 Kode pos 53177 </p></td>
</tr> 
</table>
...
<table width=100%>
<tr>
    <td align="center"><h3 style='margin-bottom:-5px' align=center><u>SURAT KETERANGAN TIDAK MAMPU</u> </h3></td>
</tr> 
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_sktm]"; ?>/DS/IX/2019</p></td>
</tr> 
</table>
