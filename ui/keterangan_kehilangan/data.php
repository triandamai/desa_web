...
?>
<div class="card-body">
                                <h4 class="card-title">Data Pengajuan Surat Kehilangan</h4>
                                    ...
                                    <table id="multi_col_order"
                                        ...
                                        foreach($db->tampil_kehilangan(null) as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?= $base_url.'/ui/cetak_kehilangansurat.php?module=cetak_pengantar_skck&&ref=yes&&id='.$data['id_kehilangan']; ?>"lass="btn waves-effect waves-light btn-outline-primary">
                                                    Cetak
                                                    </a>
                                                    <form action="" method="POST">
                                                        <input type="hidden" name="id" value="<?=  $data['id_kehilangan'];?>">
