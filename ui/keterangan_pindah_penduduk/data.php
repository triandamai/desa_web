<?php 
        ...
        if(isset($_POST['hapus'])){
            $id = $_POST['id'];
            $simpan = $db->hapus_suket_pindah_penduduk($id);
            if($simpan){
                                    ...
                                    <table id="multi_col_order"
                                        ...
                                        foreach($db->tampil_suket_pindah_penduduk(null) as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?= $base_url.'/ui/cetak_pindahsurat.php?module=cetak_pengantar_skck&&ref=yes&&id='.$data['id_pindah']; ?>"lass="btn waves-effect waves-light btn-outline-primary">
                                                    Cetak
                                                    </a>
                                                    <form action="" method="POST">
                                                        <input type="hidden" name="id" value="<?=  $data['id_pindah'];?>">
