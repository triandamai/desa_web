     ...
     4 =>array(
        ...
        "child" => array(
            0 => array(
                "id"=> 1,
                "name" => "CETAK SKCK",
                "link" => $base_url.'/ui/cetak_pengantar_skck.php?module=cetak_pengantar_skck&&ref=yes',
                "child" =>"",
            ),
            1 => array(
                "id"=> 1,
                "name" => "CETAK SUKET BELUM MENIKAH",
                "link" => $base_url.'/ui/cetak_belumpernahmenikah.php?module=cetak_pengantar_skck&&ref=yes',
                "child" =>"",
            ),
            2 => array(
                "id"=> 1,
                "name" => "CETAK KETERANGAN UNTUK MENIKAH",
                "link" => $base_url.'/ui/cetak_untukmenikah.php?module=cetak_pengantar_skck&&ref=yes',
                "child" =>"",
            ),
            3 => array(
                "id"=> 1,
