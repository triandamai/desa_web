...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Apr 2020 pada 04.17
...
INSERT INTO `tbl_data` (`id_data`, `nik`, `nkk`, `nama`, `jenis_kel`, `tgl_lahir`, `umur`, `tmp_lahir`, `alamat`, `no_rt`, `no_rw`, `kelurahan`, `shdk`, `status_kawin`, `pendidikan`, `kewarganegaraan`, `agama`, `pekerjaan`, `gol_darah`, `akta_lahir`, `no_akta_lahir`, `akta_kawin`, `no_akta_kawin`, `akta_cerai`, `no_akta_cerai`, `nama_ayah`, `nama_ibu`) VALUES
(1, 12345678, 8907988, 'Alucard', 'Laki-laki', '2020-01-01', 18, 'Ajibarang', 'Banyumas', 5, 8, 'Lumbir', 'jhkj', 'Sudah-Kawin', 'SD', NULL, 'kristen', 'Karyawan Perusahaan', 'AB', 'hjk', 0, 'bbhj', 0, 'hb jh', 0, 'bbh', 'buib');
...
INSERT INTO `tbl_hajatan` (`id_hajatan`, `id_data`, `keperluan`, `keterangan`, `masa_berlaku`) VALUES
(470, 1, 'dfd', 'ds', '0000-00-00'),
(471, 1, 'sd', 'ds', '0000-00-00'),
(472, 1, 'sa', 'sa', '0000-00-00');
...
--
ALTER TABLE `tbl_belum_nikah`
  MODIFY `id_belum_nikah` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `tbl_data`
--
ALTER TABLE `tbl_data`
  MODIFY `id_data` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_hajatan`
  MODIFY `id_hajatan` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=473;
...
--
ALTER TABLE `tbl_nikah`
  MODIFY `id_nikah` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_skck`
  MODIFY `id_skck` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=272;
